...
namespace Tools
{
    internal static class ResourceLoader
    {
        ...
        public static T InstantiateObject<T>(
            T prefab, Transform parent, bool worldPositionStays) where T : Object
        {
            return Object.Instantiate(prefab, parent, worldPositionStays);
        }

        public static T LoadAndInstantiateObject<T>(
            ResourcePath path, Transform parent, bool worldPositionStays) where T : Object
        {
